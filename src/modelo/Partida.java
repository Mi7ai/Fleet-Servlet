...
public class Partida {
	...
	private boolean misDisparos[][] = null; 
	/**
	...
	public Partida(int nf, int nc, int nb) {
		...
		iniciaDisparos(nf, nc); // Inicia matriz booleanos a falso
	...
	/*
	 * Inicia matriz disparos a false
	 */
    ...
    /*
     * Devuelve true/false en la posicion de la matriz
     */
    public boolean casillaDisparada(int nf, int nc) {
    	return misDisparos[nf][nc];
    }
    /*
     * Devuelve contenido casilla f-c
     */
	...
	/**
	 * Devuelve el numero de disparos  hasta el momento
	 */
	...
	/**
	 * Devuelve los barcos que quedan
	 */
